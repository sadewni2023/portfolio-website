...
function ContactPage() {
    ...
    return (
        <>
            <Helmet>
                <title>Contact - Sadewni Mendis</title>
                <meta name="description" content="Get in touch with Sadewni Mendis for freelance projects and full-time opportunities." />
            </Helmet>

            <div className="min-h-screen flex flex-col bg-background selection:bg-accent/30 selection:text-white relative overflow-hidden">
                {/* Background Gradients */}
                <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-primary/10 rounded-full blur-[120px] -z-10 pointer-events-none translate-x-1/3 -translate-y-1/3" />
                <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-accent/10 rounded-full blur-[120px] -z-10 pointer-events-none -translate-x-1/3 translate-y-1/3" />
                            ...
                            >
                                <div className="glass-panel p-8 md:p-10 rounded-3xl relative overflow-hidden">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                                        ...
                                        >
                                            {isSubmitting ? (
                                                <span className="opacity-80">Transmitting...</span>
                                            ) : (
                                                <>
                                                    Send Message
                                    ...
                                    <div className="space-y-6">
                                        {contactInfo.map((info, index) => (
                                            <div key={index} className="flex items-center gap-5 group">
                                                <div className="flex-shrink-0 w-14 h-14 rounded-2xl glass-card flex items-center justify-center group-hover:bg-accent/20 group-hover:border-accent/40 transition-all duration-300 group-hover:scale-110">
